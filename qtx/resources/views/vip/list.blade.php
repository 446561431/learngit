...
@section('content')
			...
			<div class="row">
				<div class="col-md-12">
					...
					{!! Form::open(array('url' => '/vipsearch', 'method' => 'get','class' => 'form-horizontal','role' => 'form')) !!}
							<input type='text' name='search' id='search' placeholder='按照用户名称搜索'/>
...
/*        $("#sea").click(function(){
        	var val = $("#search").val();
        	$.get('/vipsearch',{val:val},function(data){
        		//alert(data)
        		$("#div").html(data)
        	})
        })*/
