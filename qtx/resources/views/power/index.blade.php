                    ...
                    <div class="row">
                        ...
                        <table class="table responsive">
                            ...
                            @foreach($data as $k => $v)
                                <tr>
                                    <td>
                                        <input type="checkbox" name="one[]" class="one" value="{!! $v -> node_id !!}">
                                    </td>
                                    <td>
                                        {!! $v -> node_id !!}
                                    </td>
                                    ...
                                    <td>
                                        <a href="powerup&id={!! $v->node_id !!}"><button class="btn btn-gray">修改</button></a>
                                        <button class="btn btn-gray del" value="{!! $v -> node_id !!}">删除</button>
                                    </td>
                                </tr>
                             @endforeach
                            </tbody>
        ...
        $(document).ready(function(){
            ...
            */
            ...
            $(document).on("click",'.del',function(){
                ...
                if(confirm('您确定要删除么'))
                {
                  $.get("powerdel/id="+obj.attr("value"),function(data){
                        if(data == 1) {
